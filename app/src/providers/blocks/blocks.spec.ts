  ...
  beforeEach(async(() => {
    ...
    it('should ', inject([BlocksProvider, MockBackend], (blocksProvider, mockBackend) => {
      ...
      blocksProvider.getBlocks().subscribe((response) => {
        let blocks = JSON.parse(response._body).blocks;
