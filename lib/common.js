...
console.log('[common.js.133:issuerObjectValue:]',issuerObjectValue,issuerObject.value.toString()); //TODO
      var subjectObjectValue = subjectObject.value.toString('hex');
console.log('[common.js.135:subjectObjectValue:]',subjectObjectValue, subjectObject.value.toString()); //TODO
...
console.log('[common.js.429:parts:]',parts); //TODO
