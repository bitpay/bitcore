...
console.log('[index.js.48:sig:]',sig); //TODO
  var pki_data = this.get('pki_data');
console.log('[index.js.49:pki_data:]',pki_data); //TODO
  ...
  var der;
  var pem;
console.log('[index.js.59:type:]',type); //TODO

  if (type !== 'none') {
    var verifier = crypto.createVerify('RSA-' + type);
    verifier.update(buf);
console.log('[index.js.64:verifier:]',verifier); //TODO
    var signedCert = pki_data[0];
    der = signedCert.toString('hex');
    pem = PaymentProtocol.DERtoPEM(der, 'CERTIFICATE');
console.log('[index.js.68:pem:]',pem); //TODO
    verified = verifier.verify(pem, sig);
console.log('[index.js.69:verified:]',verified); //TODO
  } else {
    verified = true;
  }
