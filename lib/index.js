...
console.log('[index.js.58]'); //TODO
  ...
  pem = PaymentProtocol.DERtoPEM(der, 'CERTIFICATE');
  var caName = RootCerts.getTrusted(pem);
console.log('[index.js.77:caName:]',caName); //TODO

  // Try to complete the Chain with the Root cert
  if (!caName) {
    var rootCert;
...
console.log('[index.js.92:pem:]',pem, der); //TODO
        chain.push(der);
console.log('[index.js.96:chain:]',chain); //TODO
      }
    });
  }
...
console.log('[index.js.132:chainVerified:]',chainVerified, caName); //TODO
...
console.log('[index.js.152:cert:]',i, cert); //TODO
    var der = cert.toString('hex');
    var pem = PaymentProtocol.DERtoPEM(der, 'CERTIFICATE');
    var name = RootCerts.getTrusted(pem);

    var ncert = chain[i + 1];
console.log('##### AT:',i); //TODO
...
console.log('[index.js.186:validityVerified:]',validityVerified); //TODO

    // Check the Issuer matches the Subject of the next certificate:
    var issuerVerified = PaymentProtocol.validateCertIssuer(c, nc);
console.log('[index.js.189:issuerVerified:]',issuerVerified); //TODO
...
console.log('[index.js.198:sigVerified:]',sigVerified); //TODO
