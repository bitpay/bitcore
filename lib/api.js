...
API.prototype.createWalletFromOldCopay = function(username, password, blob, cb) {
  ...
  this.createWallet(opts.name, username, opts.m, opts.n, {network: opts.network}, function(err, secret) {


    this.credentials.addWalletInfo(walletId, walletName, m, n, walletPrivKey.toString(), copayerName);
 ...
 * @param {String} opts.walletPrivateKey - set a walletPrivateKey (instead of using 
 * @param cb
 * @return {undefined}
 */
