...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var url = `api/${opts.coin}/${opts.network}/wallet/`;
...
API.prototype.getUtxos = function(opts, cb) {
  ...
  opts = opts || {};
  var url = `api/${opts.coin}/${opts.network}/wallet/${opts.wallet}/utxos/`;
  if (opts.addresses) {
...
API.prototype.getBalance = function(opts, cb) {
  ...
  var url = `api/${opts.coin}/${opts.network}/wallet/${opts.wallet}/balance`;
