  ...
  self._doGetRequest('/v1/txproposals/', function(err, txps) {
    ...
    async.every(txps,
      function(txp, acb) {
        ...
        self.checkTxProposal(txp, function(err, isLegit) {
          return acb(isLegit);
        });
      },
      function(isLegit) {
...
API.prototype.checkTxProposal = function(txp, cb) {
  var self = this;
  txp._paypro = null;
  if (txp.payProUrl && !this.doNotVerifyPayPro) {
    ...
    return cb(null, Verifier.checkTxProposal(self.credentials, txp));
  }
};
