...
API.prototype.importFromExtendedPrivateKey = function(xPrivKey, opts, cb) {
  ...
  try {
    this.credentials = Credentials.fromExtendedPrivateKey(opts.coin || 'btc', xPrivKey, opts.account || 0, opts.derivationStrategy || Constants.DERIVATION_STRATEGIES.BIP44);
  } catch (e) {
...
API.prototype._addSignaturesToBitcoreTx = function(txp, t, signatures, xpub) {
  ...
  _.each(signatures, function(signatureHex) {
    ...
    try {
      var signature = Bitcore_[txp.coin].crypto.Signature.fromString(signatureHex);
