 ...
 * @param {String} opts - Device token (unsubscribe all) or null (unsubscribe current wallet).
 * @return {Callback} cb - Return error if exists
 */
API.prototype.pushNotificationsUnsubscribe = function(opts, cb) {
  if (opts)
    var url = '/v1/pushnotifications/subscriptions/' + opts;
  else
    var url = '/v1/pushnotifications/subscriptions/';
