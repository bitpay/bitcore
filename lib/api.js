 ...
 * @param {Number} opts.language
 */
API.prototype.seedFromRandomWithMnemonic = function(network, opts) {
  $.checkArgument(_.isUndefined(opts) || _.isObject(opts), 'DEPRECATED: second argument should be an options object.');

  opts = opts || {};
  this.credentials = Credentials.createWithMnemonic(network || 'livenet', opts.passphrase, opts.language || 'en', opts.account || 0);
};
 ...
 * @param {Number} opts.account
 */
API.prototype.seedFromMnemonic = function(words, network, opts) {
  $.checkArgument(_.isUndefined(opts) || _.isObject(opts), 'DEPRECATED: second argument should be an options object.');

  opts = opts || {};
  this.credentials = Credentials.fromMnemonic(network || 'livenet', words, opts.passphrase, opts.account || 0);
};
...
API.prototype.importFromMnemonic = function(words, network, opts, cb) {
