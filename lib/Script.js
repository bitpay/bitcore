...
Script.prototype.getAddrStr = function(netname) {
  ...
  switch (type) {
    ...
    case Script.TX_PUBKEYHASH:
      addr = new Address(network.addressVersion, this.captureOne());
      addrStrs.push(addr.toString());
      break;
    case Script.TX_SCRIPTHASH:
      addr = new Address(network.P2SHVersion, this.captureOne());
      addr.networkHint = netname;
      addrStrs.push(addr.toString());
      break;
