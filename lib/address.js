...
function decodeCashAddress(address) {
  ...
  $.checkArgument(hasSingleCase(encodedPayload), `Mixed case in address payload: ${encodedPayload}.`);
  ...
  const network = Networks.get(prefix, 'prefix');
