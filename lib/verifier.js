...
Verifier.checkPaypro = function(txp, payproOpts) {
  ...
  var bitcore = Bitcore_[txp.coin || 'btc'];
  ...
  // workaround different BCH addresses formats
  var payProAddress = (new bitcore.Address(payproOpts.toAddress)).toString();
  return (toAddress == payProAddress && amount == payproOpts.amount);
};
