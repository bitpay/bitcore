...
RootCerts.getTrusted = function(pem) {
  ...
  if (!Object.prototype.hasOwnProperty.call(RootCerts.trusted, pem)) return;
  return RootCerts.trusted[pem];
};

PayPro.getCert =
RootCerts.getCert = function(name) {
  name = name.replace(/^s+|s+$/g, "");
  if (!Object.prototype.hasOwnProperty.call(RootCerts.certs, name)) return;
  return RootCerts.certs[name];
};
