...
Mnemonic.fromSeed = function(seed, wordlist) {
  if(!Buffer.isBuffer(seed)) {
    throw new bitcore.errors.InvalidArgument('seed', 'Must be a Buffer.');
  }
  if(!_.isArray(wordlist)&&!_.isString(wordlist)) {
    throw new bitcore.errors.InvalidArgument('wordlist', 'Must be a string or an array.');
  }
