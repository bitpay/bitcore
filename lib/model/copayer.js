...
Copayer.prototype.createAddress = function(wallet, isChange, step) {
...
/// Only for power scan
Copayer.prototype.getSkippedAddress = function() {
  $.checkState(this.isComplete());

  var self = this;
  var next = this.addressManager.getNextSkippedPath();
  if (!next) return;
  var address = Address.derive(wallet.id, wallet.addressType, wallet.publicKeyRing, next.path, wallet.m, wallet.coin, wallet.network, next.isChange);
  return address;
};
