...
console.log('[interpreter.js.84]'); //TODO
  // evaluate scriptSig
  if (!this.evaluate()) {

console.log('[interpreter.js.87]', this.errstr); //TODO
    return false;
  }

console.log('[interpreter.js.93]'); //TODO
...
console.log('[interpreter.js.433]', e); //TODO
    ...
    switch (opcodenum) {
      ...
      case Opcode.OP_EQUALVERIFY:
        //case Opcode.OP_NOTEQUAL: // use Opcode.OP_NUMNOTEQUAL
        {
          ...
          buf1 = stacktop(-2);
console.log('[interpreter.js.1271:buf1:]',buf1); //TODO
          buf2 = stacktop(-1);
console.log('[interpreter.js.1273:buf2:]',buf2); //TODO
          var fEqual = buf1.toString('hex') === buf2.toString('hex');
console.log('[interpreter.js.1275:fEqual:]',fEqual); //TODO
          this.stack.pop();
          this.stack.pop();
...
console.log('[interpreter.js.1700] STACK BIN2NUM', this.stack); //TODO

          buf1 = stacktop(-1);
console.log('[interpreter.js.1700:buf1:]',buf1); //TODO
          buf2 = Interpreter._minimallyEncode(buf1);
console.log('[interpreter.js.1701:buf2:]',buf2); //TODO
...
console.log('[interpreter.js.1709] OK END BIN2NUM', this.stack); //TODO
        } 
        break;        
