...
function TransactionBuilder(opts) {
  opts = opts || {};
  this.currency = opts.currency || 'btc';
  this.vanilla = {};
...
TransactionBuilder.infoForP2sh = function(opts, networkName, currency) {
  ...
  var version = networkName === 'testnet' ?
    networks[currency].testnet.P2SHVersion : networks[currency].livenet.P2SHVersion;
...
TransactionBuilder.prototype._multiFindKey = function(walletKeyMap, pubKeyHash) {
  var wk;
  [networks[this.currency].livenet, networks[this.currency].testnet].forEach(function(n) {
