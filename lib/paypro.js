...
PayPro._getPayProRefundOutputs = function(addrStr, amount) {
  ...
  console.log('PayPro refund address set to:' + addrStr);
...
PayPro.send = function(opts, cb) {
  ...
  var payment = PayPro._createPayment(opts.merchant_data, opts.rawTx,
    opts.refundAddr, opts.amountSat);
console.log('[paypro.js.201:payment:]',payment); //TODO
};
