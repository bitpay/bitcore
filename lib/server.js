  ...
  self._runLocked(cb, function(cb) {
    ...
    async.whilst(
      () => {
        return !done;},
      (next) => {
        bc.getTransactions(wallet, sinceId, pageSize, (err, txs) => {
...
console.log('[server.js.3402:idx:]',idx); //TODO
          ...
          pageSize = Defaults.V8_TX_PAGE_SIZE;
          return next();
        });
      },
      (err) => {
