...
console.log('[server.js.1406:addressToPath:]',addressToPath); //TODO
      _.each(allUtxos, function(utxo) {
        if (!opts.addresses && !addressToPath[utxo.address]) {
          log.warn('Ignored UTXO!: ' + utxo.address);
          return;
        }
console.log('[server.js.1408:utxo:]',utxo); //TODO
...
WalletService.prototype.getBalance = function(opts, cb, i) {
  ...
  let setAddresses = (cb1) => {
    var bc = self._getBlockchainExplorer(opts.coin, wallet.network);
    if (!bc) {
...
console.log('##################################'); //TODO
console.log('#### rechecking utxos ###') //TODO
console.log(txp.inputs) //TODO
console.log('##################################'); //TODO
        self._getUtxosForCurrentWallet({
...
console.log('[server.js.3190] #########  SYNC WALLET CALLED'); //TODO
  var bc = self._getBlockchainExplorer(wallet.coin, wallet.network);
  if (!bc) {
