# Stealth Addresses _for_ [![bitcore Logo](http://bitpay.github.io/bitcore/images/bitcore-logo-with-ball.svg)][bitcore]
...
A module for [bitcore][bitcore] that implements [Stealth Addresses][Stealth].
