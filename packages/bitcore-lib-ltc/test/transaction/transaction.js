...
describe('Transaction', function() {
  ...
  describe('getSighash', function() {
    ...
    it('should get sighash for multisigscripthash input', function() {
      const t = new Transaction().from(p2shUtxoWith1LTC, [p2shPublicKey1, p2shPublicKey2, p2shPublicKey3], 2);
    ...
    it('should get sighash for witness multisigscripthash input', function() {
      const t = new Transaction().from(p2wshUtxoWith1LTC, [p2shPublicKey1, p2shPublicKey2, p2shPublicKey3], 2);
      (t.inputs[0] instanceof MultiSigScriptHashInput).should.equal(true);
      const sighash = t.inputs[0].getSighash(t, p2shPublicKey1, 0);
      should.exist(sighash);
    ...
    // unskip if/when we add taproot support to bitcore-lib-ltc
    it.skip('should get sighash for taproot input', function() {
      const utxo = {
