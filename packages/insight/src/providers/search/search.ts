...
export class SearchProvider {
  ...
  private inputTypes: InputType[] = [
    ...
    // Standard Ecash / XEC address
    {
      ...
      dataIndex: 2,
      type: 'address',
      chainNetworks: [{ chain: 'XEC', network: 'mainnet' }]
    },
    // bech32 BTC Address
    {
    ...
    // Standard Lotus / Xaddress XPI address
    {
      ...
      dataIndex: 2,
      type: 'address',
      chainNetworks: [{ chain: 'XPI', network: 'mainnet' }]
    },
    // Standard Lotus / Xaddress XPI address
    {
      ...
      dataIndex: 2,
      type: 'address',
      chainNetworks: [{ chain: 'XPI', network: 'testnet' }]
    },
    ...
    // Testnet XEC Address
    {
      ...
      dataIndex: 2,
      type: 'address',
      chainNetworks: [{ chain: 'XEC', network: 'testnet' }]
    },
    // ETH Address
    {
