...
describe('Witness Address', function() {
  ...
  describe('instantiation', function() {
    ...
    it('should create taproot address from public key', function() {
      var priv = new bitcore.HDPrivateKey('tprv8ZgxMBicQKsPe7EVJZjbgFcxVx51KrdMU8MicmR6KBbtTYhuzzdFK8Q7B6GXaTJxaAfpw1gF1dXDjg1DD3K8dchjMVeS214MSFj1bA5iAnH');
      var newPriv = priv.deriveChild("m/86'")
      // var trAddress = priv.publicKey.toAddress('testnet', 'taproot');


      var rootpriv = 'xprv9s21ZrQH143K3GJpoapnV8SFfukcVBSfeCficPSGfubmSFDxo1kuHnLisriDvSnRRuL2Qrg5ggqHKNVpxR86QEC8w35uxmGoggxtQTPvfUu';
      var rootpub = 'xpub661MyMwAqRbcFkPHucMnrGNzDwb6teAX1RbKQmqtEF8kK3Z7LZ59qafCjB9eCRLiTVG3uxBxgKvRgbubRhqSKXnGGb1aoaqLrpMBDrVxga8'

      // Account 0, root = m/86'/0'/0'
      var xprv = 'xprv9xgqHN7yz9MwCkxsBPN5qetuNdQSUttZNKw1dcYTV4mkaAFiBVGQziHs3NRSWMkCzvgjEe3n9xV8oYywvM8at9yRqyaZVz6TYYhX98VjsUk';
      var xpub = 'xpub6BgBgsespWvERF3LHQu6CnqdvfEvtMcQjYrcRzx53QJjSxarj2afYWcLteoGVky7D3UKDP9QyrLprQ3VCECoY49yfdDEHGCtMMj92pReUsQ';

      var priv = new bitcore.HDPrivateKey(rootpriv);
      var pub  = priv.hdPublicKey;

      pub.xpubkey.should.equal(rootpub);
      
      priv.deriveChild("m/86'/0'/0'").xprivkey.should.equal(xprv);
      priv.deriveChild("m/86'/0'/0'").hdPublicKey.xpubkey.should.equal(xpub);
