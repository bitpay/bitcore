...
describe('Networks', function() {
  ...
  it('will enable/disable regtest Network', function() {
    ...
    // Zclassic testnet values
    networks.testnet.networkMagic.should.deep.equal(new Buffer('f99f24b6', 'hex'));
  ...
  it('tests only for the specified key', function() {
    // Zclassic testnet pubkeyhash is 0x1d25
  ...
  it('can test for multiple keys', function() {
    // Use Zclassic testnet pubkeyhash/scripthash values
