...
describe.skip('Transaction', function() {
  // Skipped: Bitcoin test vectors - Zclassic-specific tests needed
  ...
  // Hash derivato dall'indirizzo Zclassic t1Uekrhh3BEKhV9iKHLFQa3GppxqTTraEfQ
  var testScriptAsm = 'OP_DUP OP_HASH160 0x14 0x763b5d5c2aacd860729d290ad641cf119eb7b851 OP_EQUALVERIFY OP_CHECKSIG';
  var testScriptHex = '76a914763b5d5c2aacd860729d290ad641cf119eb7b85188ac';
  ...
  var testTransaction = new Transaction()
    .from({
      txId: testPrevTx,
      outputIndex: 0,
      script: Script.fromASM(testScriptAsm), // 👈 converte asm → script valido
      satoshis: testAmount
    })
    .to('tmXZA5pSjq9UvyKBhStDT83jneku5AP62Y6', testAmount - 10000);
  ...
  it('will not accept NaN as an amount', function() {
    (function() {
      var stringTx = new Transaction().to('tmW67Y1nWq6sC5drB1vp5u7ePPk5eLBcoqo', NaN);
  ...
  var fromAddress = 'tmFamMb4uLJKCe1aJ6XYyyY1BQAUktwgfNs'; // Zclassic testnet key #1
  ...
  anyoneCanSpendUTXO.script = new Script().add('OP_TRUE').toString();

  // Zclassic testnet addresses:
  var toAddress = 'tmBfmDAd9V4aJxw9CxBnvf8f56KBN1DGSuM';       // key #2
  var changeAddress = 'tmHdvxmkNAK6sVAD2BG67vN6eEu4VfLQMrC';     // key #3

  // P2SH segnaposto (verrà sovrascritto dopo la createMultisig)
  var changeAddressP2SH = '';
  ...
  // ---- P2SH multisig keys (Zclassic!) ----
  var p2shPrivateKey1 = PrivateKey.fromWIF('L4fFptrcr8mmrhtuwsHGT39DiW3QzzDYVaFW7NmDR9xXFCataWJb');
  var p2shPublicKey1 = p2shPrivateKey1.toPublicKey();

  var p2shPrivateKey2 = PrivateKey.fromWIF('KyBma9weekjqJsxqG4AZw8U2GYbFzbxPMorT7PnkRibnogptmqKA');
  var p2shPublicKey2 = p2shPrivateKey2.toPublicKey();
 
  var p2shPrivateKey3 = PrivateKey.fromWIF('L2J4xuRWP4DeE2vbMYiCTFj1NwKBy4PZATeV6coT6MzEfpBuvWnL');
  var p2shPublicKey3 = p2shPrivateKey3.toPublicKey(); 


  // ---- Zclassic P2SH multisig ----
  ...
  // sovrascrivo lo P2SH address perché ora lo abbiamo
  changeAddressP2SH = p2shAddress.toString();

  var p2shUtxoWith1BTC = {
    address: p2shAddress.toString(),
    txId: 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
    outputIndex: 0,
    script: Script.buildScriptHashOut(p2shAddress).toString(),
    satoshis: 1e8
  };
    ...
    it('not if _satoshis and _satoshisBN have different values', function() {
      var tx = new Transaction()
        .from({
          'txId': testPrevTx,
          'outputIndex': 0,
          'script': Script.fromASM(testScriptAsm),
          'satoshis': testAmount
        })
        .to('tmW67Y1nWq6sC5drB1vp5u7ePPk5eLBcoqo', testAmount - 10000);
