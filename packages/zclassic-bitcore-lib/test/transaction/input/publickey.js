...
describe('PublicKeyInput', function() {
  ...
  var utxo = {
    ...
    vout: 0,
    address: 'tmYZ1DyGKV1tVW3HoRwJgSPJcTwzXRE5r1b',
  ...
  var destKey = new PrivateKey('f9fe698673c02d2b6335c8a2995e385235f110ed28dcb43400cdb28eb9f7a2a0');
  ...
  it('returns an empty array if private key mismatches', function() {
    ...
    tx.to(destKey.toAddress(), 10000);
    var input = tx.inputs[0];
    var signatures = input.getSignatures(tx, new PrivateKey('f9fe698673c02d2b6335c8a2995e385235f110ed28dcb43400cdb28eb9f7a2a0'), 0);
