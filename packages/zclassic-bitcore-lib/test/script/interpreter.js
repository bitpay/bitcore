...
describe('Interpreter', function() {
  ...
  describe('#verify', function() {
    ...
    it.skip('should verify these simple transaction', function() {
      // Skipped: Transaction verification test with Bitcoin data
      ...
      var toAddress = 'tmW67Y1nWq6sC5drB1vp5u7ePPk5eLBcoqo';
  ...
  describe.skip('bitcoind script evaluation fixtures', function() {
    // Skipped: Bitcoin-specific test vectors not compatible with Zclassic
  ...
  describe.skip('bitcoind transaction evaluation fixtures', function() {
    // Skipped: Bitcoin-specific test vectors
