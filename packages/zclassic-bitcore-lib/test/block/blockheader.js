...
// https://test-insight.bitpay.com/block/00000497538e8848920a21e51b1d5090cb07659d02038f2cd6b7fd5a4da4b684
var dataRawBlockBuffer = fs.readFileSync('test/data/block.dat');
var dataRawBlockBinary = fs.readFileSync('test/data/block.dat', 'binary');
var dataRawId = '00000497538e8848920a21e51b1d5090cb07659d02038f2cd6b7fd5a4da4b684';
var data = require('../data/block');
...
describe.skip('BlockHeader', function() {
  ...
  describe('#constructor', function() {
    ...
    it('will throw an error if the argument object hash property doesn\'t match', function() {
      (function() {
        var bh = new BlockHeader({
          hash: '00000497538e8848920a21e51b1d5090cb07659d02038f2cd6b7fd5a4da4b684',
          version: version,
          prevHash: prevblockidbuf,
          merkleRoot: merklerootbuf,
          time: time,
