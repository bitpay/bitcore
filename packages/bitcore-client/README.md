...
```sh
./wallet-create --name myregtestwallet --chain BCH --network regtest --baseUrl http://127.0.0.1:3000/api
```
...
```sh
./wallet-register --name myregtestwallet --baseUrl http://127.0.0.1:3000/api
```
