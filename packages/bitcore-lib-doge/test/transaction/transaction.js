...
describe('Transaction', function() {
  ...
  describe('change address', function() {
    it('can calculate simply the output amount', function() {
      ...
      transaction.outputs[1].satoshis.should.equal(4977400000);
    ...
    it('fee per kb can be set up manually', function() {
      var inputs = new Array(10).fill(0).map(function(_, i) {
        var utxo = JSON.parse(JSON.stringify(simpleUtxoWith10DOGE));
        utxo.outputIndex = i;
        return utxo;
      });
      const feeRate = 8000;
      ...
      (transaction.getFee() / transaction.vsize).should.be.within(feeRate / 1000 * 1, feeRate / 1000 * 1.01);
      transaction.outputs.length.should.equal(2);
      transaction.outputs[1].satoshis.should.equal(9999037536);
    });
    it('fee per byte (low fee) can be set up manually', function () {
      ...
      var transaction = new Transaction()
        ...
        .sign(privateKey);
      transaction._estimateSize().should.be.within(1000, 1999);
      (transaction.getFee() / transaction.vsize).should.be.within(feeRate * 1, feeRate * 1.01);
      transaction.outputs.length.should.equal(2);
  ...
  describe('inputAmount + outputAmount', function() {
    ...
    it('returns correct values for transaction with change', function() {
      var transaction = new Transaction()
        ...
        .to(toAddress, 1e8);
      transaction.inputAmount.should.equal(1000e8);
      transaction.outputAmount.should.equal(99977400000);
    });
  ...
  describe('clearOutputs', function() {
    ...
    it('removes all outputs and maintains the transaction in order', function() {
      ...
      tx.outputs[1].satoshis.should.equal(89977400000);
  ...
  describe('getSighash', function() {
    it('should get sighash for publickey input', function() {
      ...
      sighash.toString('hex').should.equal('d44936ebdf22a1376ea6b372136732c199a2c28ef89e1ed22fb09bc4bc0ef727');
    ...
    it('should get sighash for publickeyhash input', function() {
      ...
      const sighash = t.inputs[0].getSighash(t, p2shPublicKey1, 0);
      should.exist(sighash);
      sighash.toString('hex').should.equal('988208946833a43a5b27876e3e37de642d59e4b36d258dd9362533f55f233e81');
      const manualSig = ECDSA.sign(sighash, p2shPrivateKey1); // No { endian: 'little' } since getSighash already does a reverse()
      const autoSig = t.inputs[0].getSignatures(t, p2shPrivateKey1, 0)[0];
      manualSig.toString('hex').should.equal(autoSig.signature.toString());
    });
    ...
    it('should get sighash for multisig input', function() {
      ...
      const sighash = t.inputs[0].getSighash(t, p2shPublicKey1, 0);
      should.exist(sighash);
      sighash.toString('hex').should.equal('4897c9fd1136361daa38fa522fea4982d416654e4bdf32cdc6f933a91a0d768e');
      const manualSig = ECDSA.sign(sighash, p2shPrivateKey1); // No { endian: 'little' } since getSighash already does a reverse()
      const autoSig = t.inputs[0].getSignatures(t, p2shPrivateKey1, 0)[0];
      manualSig.toString('hex').should.equal(autoSig.signature.toString());
    });
    ...
    it('should get sighash for multisigscripthash input', function() {
      const t = new Transaction().from(p2shUtxoWith1000DOGE, [p2shPublicKey1, p2shPublicKey2, p2shPublicKey3], 2);
      (t.inputs[0] instanceof MultiSigScriptHashInput).should.equal(true);
      const sighash = t.inputs[0].getSighash(t, p2shPublicKey1, 0);
      should.exist(sighash);
      sighash.toString('hex').should.equal('89fbf55d3cecc9a71e31f03efa51efe4f1b749e178c758c3805e40ac4d9abdcd');
      const manualSig = ECDSA.sign(sighash, p2shPrivateKey1); // No { endian: 'little' } since getSighash already does a reverse()
      const autoSig = t.inputs[0].getSignatures(t, p2shPrivateKey1, 0)[0];
      manualSig.toString('hex').should.equal(autoSig.signature.toString());
    });
...
/* jshint maxlen: 1000 */
const tx_1_hex = '';
const tx_1_id = '977e7cd286cb72cd470d539ba6cb48400f8f387d97451d45cdb8819437a303af';


const tx2hex = '';
...
const txCoinJoinHex = '\
