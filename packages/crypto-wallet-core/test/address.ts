...
describe('Address Derivation', () => {
  it('should be able to generate a valid BTC address', () => {
    const xPub =
      'xpub6A4DRTebM6TS5f6cUt5YAxKXikhDZd6ANwbyomHhFFkjJApdAwnADvMRfimdaKXf1xk1LTrPuRo7eGCGYARApdytZ18SqoUv6MTYtbCx4Xv';
  ...
  it('should be able to generate a valid BCH address', () => {
    const xPub =
      'xpub6BM8E3eh3homN5uvHh12P4HQEP1QrXCuCA32JRgTTeR7Y7ChML4iV12TfSVV3KHnCGPB1kkDU26EnDHYqw3Koab2a2GjxHQuUVXE3fvcpek';
    // 'select scout crash enforce riot rival spring whale hollow radar rule sentence';
  ...
  it('should be able to generate a valid DOGE address', () => {
    const xPub =
      'tpubDCs1d9wgHkn2LYY8KrWozaUwG7a3XSkiaGtn8isiNWmLhepenSdqgH1JCMwCLW9eeRZW37D14tpBjxvb3rjkMzak4ub1qHyF4tLbQDNXZ8K';
    // 'select scout crash enforce riot rival spring whale hollow radar rule sentence';
  ...
  it('should be able to generate a valid LTC address', () => {
    const xPub =
      'tpubDCetVaW8PG7S6SuLjRGmmyVA4QtXyXTUsqXySaC4WV44igJ3aJNQgYedjL1FX12a1tDctnh3kRPybKTMUjdi9mzUm4wJF3GNSjf8GwDUHpp';
    // 'select scout crash enforce riot rival spring whale hollow radar rule sentence';
  ...
  it('should be able to generate a valid SOL address', () => {
    ...
    const result = Deriver.derivePrivateKeyWithPath('SOL', 'mainnet', seed, fullPath, false);
    const expectedResult = {
