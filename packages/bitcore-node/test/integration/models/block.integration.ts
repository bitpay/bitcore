  ...
  describe('handleReorg', () => {
    ...
    it('should successfully handle reorg', async () => {
      ...
      await TransactionStorage.collection.insertOne({
        txid: Buffer.from('a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919g'),
        txidStr: 'a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919g',
        chain: 'BTC',
        network: 'regtest',
      ...
      await TransactionStorage.collection.insertOne({
        txid: Buffer.from('8c29860888b915715878b21ce14707a17b43f6c51dfb62a1e736e35bc5d8093f'),
        txidStr: '8c29860888b915715878b21ce14707a17b43f6c51dfb62a1e736e35bc5d8093f',
        chain: 'BTC',
        network: 'regtest',
      ...
      await TransactionStorage.collection.insertOne({
        txid: Buffer.from('a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919e'),
        txidStr: 'a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919e',
        chain: 'BTC',
        network: 'regtest',
        blockHash: '3279069d22ce5af68ef38332d5b40e79e1964b154d466e7fa233015a34c27312',
        blockTime: new Date(1526326784),
      ...
      await TransactionStorage.collection.insertOne({
        txid: Buffer.from('8a351fa9fc3fcd38066b4bf61a8b5f71f08aa224d7a86165557e6da7ee13a826'),
        txidStr: '8a351fa9fc3fcd38066b4bf61a8b5f71f08aa224d7a86165557e6da7ee13a826',
        chain: 'BTC',
        network: 'regtest',
        blockHash: '3279069d22ce5af68ef38332d5b40e79e1964b154d466e7fa233015a34c27312',
        blockTime: new Date(1526326785),
      ...
      await CoinStorage.collection.insertOne({
        ...
        mintTxidStr: 'a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919g',
      ...
      await CoinStorage.collection.insertOne({
        ...
        mintTxidStr: 'a2262b524615b6d2f409784ceff898fd46bdde6a584269788c41f26ac4b4919e',
        spentTxid: Buffer.from(''),
        spentTxidStr: '',
        mintIndex: 0,
        spentHeight: SpentHeightIndicators.unspent,
      ...
      await CoinStorage.collection.insertOne({
        ...
        mintTxidStr: '8a351fa9fc3fcd38066b4bf61a8b5f71f08aa224d7a86165557e6da7ee13a826',
        spentTxid: Buffer.from(''),
        spentTxidStr: '',
        mintIndex: 0,
        spentHeight: SpentHeightIndicators.unspent,
      ...
      await CoinStorage.collection.insertOne({
        ...
        mintTxidStr: '8c29860888b915715878b21ce14707a17b43f6c51dfb62a1e736e35bc5d8093f',
        mintIndex: 0,
        spentHeight: 8,
        mintHeight: 7,
        coinbase: true,
        ...
        spentTxidStr: 'eec8570a0c960b19fa6c86c71a06ebda379b86b5fe0be0e64ba83b2e0a3d05a3'
      });
