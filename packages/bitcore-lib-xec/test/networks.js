...
describe('Networks', function() {
  ...
  it('should have ectest prefix', function() {
    expect(networks.get('testnet').prefix).to.equal('ectest');
  });

  it('should have eregtest prefix', function() {
    expect(networks.get('regtest').prefix).to.equal('ecregtest');
  });

  it('#DEPRECATED should not have bchreg prefix after enableRegtest is called', function() {
    var network = networks.get('testnet');
    networks.enableRegtest();
    expect(network.prefix).to.equal('ectest');
  });
