...
/**
 * Return a M address from a 3 address
 * Doc: https://bitcoin.stackexchange.com/questions/84428/convert-m-address-to-3-address-ltc
 */
Address.mFrom3 = function(address) {
  var addressBuffer = Base58Check.decode(address);
  if (addressBuffer[0] === 0x5) {
    addressBuffer[0] = 0x32;
    address = Base58Check.encode(addressBuffer);
  }
