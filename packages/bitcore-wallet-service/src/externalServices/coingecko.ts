...
export class CoinGeckoService {
 ...
 private coinGeckoGetCredentials() {
  ...
  coinGeckoGetTokens(req): Promise<[{chainId: string, address: string, symbol: string, name: string, decimals: number, logoURI: string}]> {
        ...
        this.request.get(
          ...
          (err, data) => {
            ...
            if (err) {
              ...
              this.storage.storeGlobalCache(cacheKey, tokens, storeErr => {
