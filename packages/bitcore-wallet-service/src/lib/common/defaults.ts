...
const Defaults = {
MIN_FEE_PER_KB = 0,MAX_FEE_PER,KB = 10000 * 1000; // 10k sat/b
MIN_TX_FEE = 0,
MAX_TX_FEE = 0.1 * 1e8,
...
SCAN_ADDRESS_GAP = Defaults.MAX_MAIN_ADDRESS_GAP + 10,
...
BALANCE_CACHE_ADDRESS_THRESOLD = Defaults.HISTORY_CACHE_ADDRESS_THRESOLD,
...
SERVER_EXE_TIME = Defaults.LOCK_EXE_TIME * 1.5,
