...
const errors = {
  ...
  NONCE_TOO_HIGH: 'Transaction cannot be signed when a pending Transaction with a lower nonce exists',
  NONCE_TOO_LOW: 'Transaction nonce too low to broadcast',
  NONCE_MISMATCH: 'Nonce out of order',
