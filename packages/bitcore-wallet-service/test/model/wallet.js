...
describe('Wallet', function() {
  ...
  describe('#getStealthAddress', function() {
    it('create multisig stealthAddress', function() {
      ...
      a.address.should.equal('9GQQ89WUUYK2QSSPK5R7DLGVC6G77T7L2P2EWFQEJZ6C3UY6ZNQ005Y8QVPGRYFLPKLS0QKFWG9AEXVX9QKE4W29SN7940X9F5ZWJ68MVAECG8CZ6P9YUQZF90VJGED5JH5WQMW36WWW8WHHHCLF6J0Z0TRJN0ZWGL4QXHS02AS0989FFSVDNU7M32N6JT6VXK6MZNNAAKLXWT3UQC0AFGY2QGQQ');
      a.scanPubKey.should.equal('0395dce12ca04201b507e6fd0cc691ef2fdf505597241990b588f09a14c0f7d087');
    ...
    it('create singlesig stealthAddress', function() {
      ...
      var w = Wallet.fromObj(inW);
      var a = w.getStealthAddress();
      a.address.should.equal('9GQQXPX5SSVGK9E60AZGMQYK84F8ZTU798HJKGFDJ2XU3KNPT8LS6HG7QYPDQJJWQPYJHKFYVK6FT68QDHGA888RHTMMU05AF83843EFH38Y06SPQQ');
      a.scanPubKey.should.equal('0304d484188b173a7f448d80963d52712f9e29ef2b212d928dc8da6159ff0d5d1e');
      a.spendPubKeys.should.deep.equal([
        "02d04a4e00492bd92465b495e8e06dd1d39ce3baf7be3e9d49e27ac729bc4e47ea",
      ]);
      a.m.should.equal(1);
