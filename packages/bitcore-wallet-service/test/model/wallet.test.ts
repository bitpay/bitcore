...
describe('Wallet', function() {
  ...
  describe('#createBEKeys', function() {
    ...
    it('key should change depending on the network', function() {
      const t = JSON.parse(JSON.stringify(testWallet));
      t.network = 'testnet';
      const w = Wallet.fromObj(t);
      const a = w.updateBEKeys();
