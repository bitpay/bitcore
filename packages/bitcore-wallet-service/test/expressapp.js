      ...
      it('latest-copay-version', function(done) {
          ...
          var server = {
            storage: {
              ...
              checkAndUseGlobalCache: sinon.stub().callsArgWith(2, null, 'v8.0.5'),
            }
          };
          ...
          // var htmlString = sinon.stub().returns({
          ...
          start(TestExpressApp, function() {
            ...
            request(requestOptions, function(err, res, body) {
              should.not.exist(err);
              res.statusCode.should.equal(200);
              console.log(server.storage.checkAndUseGlobalCache.getCalls()[0].args);
              JSON.parse(body).version.should.equal('v8.0.5');
              done();
            });
          });
      });
