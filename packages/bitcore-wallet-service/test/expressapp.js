  ...
  describe('#start', function() {
    ...
    describe.only('Routes', function() {
      ...
      it('latest-copay-version', function(done) {
          ...
          var COPAY_CACHE_DURATION_old = Defaults.COPAY_CACHE_DURATION;

          // var {Storage: s} = proxyquire('../ts_build/lib/storage', {
          //   './storage': {
          //       Storage: {
          //         storeGlobalCache: sinon.stub().callsArgWith(3, null, 'latest-copay-version', '7.1.1', () => {}),
          //         checkAndUseGlobalCache: sinon.stub('latest-copay-version', COPAY_CACHE_DURATION_old, callback),
          //       }
          //   }
          // });
          var githubResponse = sinon.stub().returns({
            ...
            "html_url": "https://github.com/bitpay/copay/releases/tag/v7.1.1",
            "id": 21158137,
          ...
          storage.checkAndUseGlobalCache('latest-copay-version', COPAY_CACHE_DURATION_old, callback);
          clock.tick(COPAY_CACHE_DURATION_old);
