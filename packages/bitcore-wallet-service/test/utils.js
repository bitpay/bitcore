...
describe('Utils', function() {
  ...
  describe('#verifyMessage', function() {
    ...
    it('should call logger when _tryImportSignature throws', function() {
      ...
      var res = Utils.verifyMessage('hola', null, '02555a2d45e309c00cc8c5090b6ec533c6880ab2d3bc970b3943def989b3373f16');
      should.exist(res);
      should.equal(logSpy.called,true);
      res.should.equal(false);
      logSpy.restore();
    });
    ...
    it('should call logger when _tryVerifyMessage throws', function() {
      var logSpy = sinon.spy(logger,"error");
      var fn = () => [];
      var tryImportSigStub = sinon.stub(Utils, '_tryImportSignature').callsFake(fn);
      var tryImportPubKeyStub = sinon.stub(Utils, '_tryImportPublicKey').callsFake(fn);
      ...
      logSpy.restore();
      tryImportSigStub.restore();
      tryImportPubKeyStub.restore();
    });
